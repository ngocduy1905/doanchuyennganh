	...
	<a class=" btn btn-primary" href="adduser.php">Thêm người dùng</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($con,"select user_id,first_name,last_name, email,password, mobile,address1,address2 from user_info")or die ("query 1 incorrect.....");
                        ...
                        $res = mysqli_query($con, $sql);
                          ...
                          ?>
                          <tr>
                            <td><?php echo $sn++ ?><td><?php echo $first_name?></td></td><td><?php echo $last_name ?></td><td><?php echo  $email ?></td><td>
                              <?php echo  $mobile ?></td><td><?php echo $address1 ?></td><td><?php echo  $address2 ?></td>
                            <td>
                                <a class=' btn btn-danger' href="delete-user.php?id=<?php echo $user_id?>">Delete</a>
                            </td>
                            <td>
                                <a class=' btn btn-success' href="update-user.php?id=<?php echo $user_id?>">Update</a>
                            </td>
                          </tr>
                        <?php
                            }
