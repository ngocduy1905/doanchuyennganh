						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Women's clothing</a></li>
									<li><a data-toggle="tab" href="#tab1">Men clothes</a></li>
									<li><a data-toggle="tab" href="#tab1">Men's jackets</a></li>
									<li><a data-toggle="tab" href="#tab1">Men's vest</a></li>
									<li><a data-toggle="tab" href="#tab1">Men's shirts</a></li>
								</ul>
							</div>
						</div>
					</div>
