...
#Chuỗi login_success sẽ quay trở lại hàm Ẩn danh được gọi $("#login").click() 
...
if(isset($_POST["email"]) && isset($_POST["password"])){
    ...
    $row = mysqli_fetch_array($run_query);
		...
		// chúng tôi đã tạo một cookie trong trang login_form.php, vì vậy nếu cookie đó khả dụng có nghĩa là người dùng không đăng nhập
